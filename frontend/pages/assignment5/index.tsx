...
import MatchAssignmentButton from "../../components/Matching/MatchAssignmentButton";

  
  const IP_ADDRESS = process.env.NEXT_PUBLIC_IP_ADDRESS;
  
  const assignment5 = ({ colorMode, userMode, userEmail }) => {
    ...
    useEffect(() => {
      ...
      if (seconds >= 30) {
        console.log("Leaving matching queue due to timeout 30s.")
        handleLeaveQueue();
        openDialog();
      }
    ...
    return (
      <>
      <Heading>Assignment 5 - Matching Service</Heading>        
      <Box>
